...
function closure ( target, options ){
  ...
  var cssClasses = [
	...
	function move ( event, data ) {
        ...
        // Bug fix - can drag handle off screen and release. This at least releases events if too close to page margin
        if(event.clientX < 20 || event.clientX > (window.innerWidth - 20)) {
            return end(event, data);
        }
